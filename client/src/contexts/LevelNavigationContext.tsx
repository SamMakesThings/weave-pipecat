...
const defaultLevels: Record<LevelId, LevelInfo> = {
  0: {
    id: 0,
    title: 'Level 0: Phone call or intro',
    description: 'Very easy, just ask nicely',
    image: '/images/level0.svg',
  },
  1: {
    id: 1,
    title: 'Level 1: Secret password',
    description: 'Designed to be super simple',
    image: '/images/level1.svg',
  },
  2: {
    id: 2,
    title: 'Level 2: Car discount',
    description: 'Reference to the Canada case where a dealership was forced to give a discount the LLM promised',
    image: '/images/level2.svg',
  },
  3: {
    id: 3,
    title: 'Level 3: ???',
    description: 'Open to ideas',
    image: '/images/level3.svg',
  },
  4: {
    id: 4,
    title: 'Level 4: Authorize bank transfer',
    description: 'Get the bot to authorize a bank transfer',
